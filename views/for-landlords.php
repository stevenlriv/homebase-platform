...
<div class="parallax margin-bottom-70"
	data-background="https://renthomebase.nyc3.digitaloceanspaces.com/general/theme/images/list-property-2.jpg"
	data-color="#36383e"
	data-color-opacity="0.45"
	data-img-width="2400"
	data-img-height="1680">
...
<div class="col-md-4">
	...
	<div class="icon-box-1 alternative">
		...
		<h3>Dale la bienvenida a tu primer inquilino</h3>
		<p>Ahorre tiempo dejándonos manejar el marketing y los tours de propiedades, y luego use nuestros contratos digitales para simplificar las firmas y los pagos.</p>
	</div>
</div>
...
<div class="col-md-4">
	...
	<div class="row">
		...
		<div class="col-md-12">
            ...
            <h3 class="headline margin-bottom-30 margin-top-40">Preguntas frecuentes</h3>
			...
			<div class="style-2">
				...
				<div class="toggle-wrap">
					...
					<div class="toggle-container">
						<p>Crearemos un contrato digital que puede ser firmado desde cualquier teléfono o computadora. Los inquilinos deben pagar el primer mes de alquiler y el depósito de seguridad usando una tarjeta de crédito o ACH inmediatamente después de la firma. Usando esta información, se establece una suscripción de alquiler para automatizar el proceso de cobro del alquiler.</p>
					</div>
				</div>
